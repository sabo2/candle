...
describe('Serializing', function(){
	it('Basic',function(){
		var doc = new Candle.MockDOMParser().parseFromString('<?xml version="1.0" encoding="UTF-8"?><puzzle/>');
	...
	it('serializer', function(){
		...
		assert.equal(new Candle.MockXMLSerializer().serializeToString(doc), '<svg id="mock" d="123"><g style="height:100;"/></svg>');
	});
});
